...
export class AddressController {
    ...
    create = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            ResponseHandler.success(request, response, 'Address Api added successfully!', 201, {
                Address: address,
            });
        } catch (error) {
    ...
    getById = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            ResponseHandler.success(request, response, 'Address Api retrieved successfully!', 200, {
                Address: address,
            });
        } catch (error) {
            ResponseHandler.handleError(request, response, error);
    ...
    getAllAddress = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            request.context = 'Address.GetAllHotel';

             //const id:string = await PaymentValidator.getAllPayment(request);

            const address = await this._service.getAllAddress();
            if (address == null) {
                throw new ApiError(404, 'Address not found.');
            }
            ResponseHandler.success(request, response, '  All Address  Api retrieved successfully!', 200, {
            Address: address,
            });
        } catch (error) {
            ResponseHandler.handleError(request, response, error);
    ...
    search = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            const message =
                count === 0 ? 'No records found!' : `Total ${count} Address Api records retrieved successfully!`;
    ...
    update = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            ResponseHandler.success(request, response, ' Address Api updated successfully!', 200, {
                Address: address,
            });
        } catch (error) {
            ResponseHandler.handleError(request, response, error);
    ...
    delete = async (request: express.Request, response: express.Response): Promise<void> => {
        try {
            ...
            ResponseHandler.success(request, response, 'Address Api deleted successfully!', 200, null);
        } catch (error) {
            ResponseHandler.handleError(request, response, error);
        }
    };
